...
class ResumeAnalyzer:
    ...
    def analyze_resume(self, resume_text):
        ...
        sentence_count = len(list(doc.sents))# spaCy sentence segmentation
        
        # Skills extraction
        skills = self._extract_skills(doc)# Token-based extraction
        
        # Experience analysis
        experience_years = self._analyze_experience(doc)# Feature analysis
